...
if %PLATFORM% == x64 (
    if %CONFIGURATION% == Release (
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll.dll bin\libmicrohttpd-dll.dll
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll.exp lib\libmicrohttpd-dll.exp 
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll.lib lib\libmicrohttpd-dll.lib
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll.pdb lib\libmicrohttpd-dll.pdb
    )

    if %CONFIGURATION% == Debug (
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll_d.dll bin\libmicrohttpd-dll_d.dll
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll_d.exp lib\libmicrohttpd-dll_d.exp
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll_d.ilk lib\libmicrohttpd-dll_d.ilk
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll_d.lib lib\libmicrohttpd-dll_d.lib
        cmake -E copy ..\..\..\build\microhttpd\w32\VS2013\Output\x64\libmicrohttpd-dll_d.pdb lib\libmicrohttpd-dll_d.pdb
    )
